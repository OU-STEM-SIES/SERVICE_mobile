...
@Component({
  selector: 'app-daily-record-screen3',
  templateUrl: './daily-record-screen3.page.html',
  styleUrls: ['./daily-record-screen3.page.scss'],
})
export class DailyRecordScreen3Page implements OnInit, OnDestroy {
